...
DATA(insert OID = 4192 ( "<<"	   PGNSP PGUID b f f 603 600	16	 0	 0 box_left_pt positionsel positionjoinsel ));
DESCR("is left of");
DATA(insert OID = 4193 ( "&<"	   PGNSP PGUID b f f 603 600	16	 0	 0 box_overleft_pt positionsel positionjoinsel ));
DESCR("overlaps or is left of");
DATA(insert OID = 4194 ( ">>"	   PGNSP PGUID b f f 603 600	16	 0	 0 box_right_pt positionsel positionjoinsel ));
DESCR("is right of");
DATA(insert OID = 4195 ( "&>"	   PGNSP PGUID b f f 603 600	16	 0	 0 box_overright_pt positionsel positionjoinsel ));
DESCR("overlaps or is right of");
DATA(insert OID = 4196 ( "<<|"	   PGNSP PGUID b f f 603 600	16	 0	 0 box_below_pt positionsel positionjoinsel ));
DESCR("is below");
DATA(insert OID = 4197 ( "&<|"	   PGNSP PGUID b f f 603 600	16	 0	 0 box_overbelow_pt positionsel positionjoinsel ));
DESCR("overlaps or is below");
DATA(insert OID = 4198 ( "|>>"	   PGNSP PGUID b f f 603 600	16	 0	 0 box_above_pt positionsel positionjoinsel ));
DESCR("is above");
DATA(insert OID = 4199 ( "|&>"	   PGNSP PGUID b f f 603 600	16	 0	 0 box_overabove_pt positionsel positionjoinsel ));
DESCR("overlaps or is above");
DATA(insert OID = 433 (  "@>"	   PGNSP PGUID b f f 603 600	16 511	 0 box_contain_pt contsel contjoinsel ));
DESCR("contains");
DATA(insert OID = 4200 ( "&&"	   PGNSP PGUID b f f 603 600	16 4201	 0 box_contain_pt contsel contjoinsel ));
DESCR("same as @>");
DATA(insert OID = 4201 ( "&&"	   PGNSP PGUID b f f 600 603	16 4200	 0 on_pb contsel contjoinsel ));
DESCR("same as <@");
